...
public class ChatActivity extends Activity implements RoomRequestListener, NotifyListener, ConnectionRequestListener, ChatRequestListener{
	...
	@Override
	public void onJoinRoomDone(RoomEvent arg0, String desc) {
	...
	@Override
	public void onUpdatePropertyDone(LiveRoomInfoEvent arg0, String desc) {
	...
	@Override
	public void onSendChatDone(byte result, String desc) {
	...
	@Override
	public void onSendPrivateChatDone(byte result, String desc) {
